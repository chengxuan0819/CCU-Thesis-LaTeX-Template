...
% !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
% !  注意：論文標題、作者、指導教授等資訊，請至 ccusetup.tex 修改      !
% !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
%
\input{ccusetup}
\usepackage{xeCJK} 
\setCJKmainfont[Path=fonts/, Extension=.ttf, UprightFont=*, AutoFakeBold=true]{kaiu}
\begin{document}
	% 封面 Cover
	...
	% 附錄 Appendix
	\input{backpages/appendixA}                        % 附錄（Appendix A）
	\input{backpages/appendixB}                        % 附錄（Appendix B）
