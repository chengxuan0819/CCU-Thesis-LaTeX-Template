...
由表 \ref{tab:sls_esg_results} 可清晰得知，本研究提出的動態權重機制 在 Low Load 與 Light Load 情境下達成了30.3\%的極致節能率，全面超越了傳統的 Load-based 與固定權重的 Static Lyapunov 機制。此數據證明了動態機制在多細胞環境下，具備最為強悍的冗餘能耗削減能力。
